...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', setUpMessageInput(ws, ids));
  document.addEventListener('DOMContentLoaded', setUpUsernameInput(ws, ids));
  document.addEventListener('DOMContentLoaded', setUpWebSocketMsgReception(ws, ids));
} else {
  setUpMessageInput(ws, ids);
  setUpUsernameInput(ws, ids);
  setUpWebSocketMsgReception(ws, ids);
}

function setUpMessageInput(ws, ids) {
  return () => {
...
function setUpUsernameInput(ws, ids) {
  return () => {
...
function setUpWebSocketMsgReception (ws, ids) {
  return () => {
