...
This single-page web app is [hosted on Heroku](https://mikes-chat-app.herokuapp.com). It's my second Node/Express project, and it's written entirely in vanilla Javascript (ES6), HTML, and CSS. It uses WebSockets to transmit messages between server and client.
